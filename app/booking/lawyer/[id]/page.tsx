...
function BookingForm() {
  ...
  const queryLawyerName = searchParams.get("name")
  
  const lawyerName = queryLawyerName || MOCK_LAWYER.name
    ...
    try {
      ...
      const response = await fetch("/api/cases", {
        ...
        body: JSON.stringify({
          ...
          office_name: "مكتب افتراضي", // Mock office name since it's a lawyer booking
        }),
      })
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground mt-1">احجز موعداً مع {lawyerName}</p>
          </div>
